...
const char cat_to_value[][CATEGORY_LENGTH_VALUE] = {
    "INT_TYPE",    "CHAR_TYPE",      "STRING_TYPE",
    "BOOL_TYPE",   "FLOAT_TYPE",     "OP_FORMAT",
    "DEFUN",       "DEFINT",         "DEFCHAR",
    "DEFFLOAT",    "DEFBOOL",        "DEFSTRING",
    "IF",          "ELSE",           "FOR",
    "WHILE",       "ECHO",           "RETURN",
    "BREAK",       "CONTINUE",       "NIL",
    "SET",         "READ",           "START_FUNCTION",
    "CONST_FLOAT", "CONST_INT",      "CONST_STRING",
    "CONST_CHAR",  "CONST_BOOL",     "OP_ADI",
    "OP_MULT_DIV", "OP_CONCAT",      "OP_RELACIONAL",
    "OP_LOGIC",    "OP_NOT",         "OPEN_PAREN",
    "CLOSE_PAREN", "OPEN_BRACKETS",  "CLOSE_BRACKETS",
    "OPEN_KEYS",   "CLOSE_KEYS",     "SEMICOLON",
    "COMMA",       "VOID",           "ID",
    "CAT_EOF",     "CATEGORIES_SIZE"};
